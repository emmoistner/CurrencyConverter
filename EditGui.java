...
/**
 * Gui that allows users to edit current currency information within the program
 * 
 * @author Ethan Moistner and Jinze Li
 *
 */
...
public class EditGui extends JFrame {
	...
	public void EditGui() {
		...
		save.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				File.fileExport(File.getHMC(), File.getCurrentDate(),
						newConversion);
	...
	/**
	 * Auto fills text fields when a item is selected in a combobox
	 * 
	...
	class MyItemListener implements ItemListener {
		...
		public void itemStateChanged(ItemEvent evt) {
			...
			// rate will present the selected currency's conversion rate as a
			// string. Convert double to string
			String selectedItem = (String) ratebox.getSelectedItem();
			rate = String
					.valueOf(newConversion.search(selectedItem).getRatio());
